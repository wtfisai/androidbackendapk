  ...
  getComprehensiveTutorialSlides() {
    return [
      // Welcome slides
      {
        ...
        content:
          "This comprehensive tutorial will guide you through all features of the Android Remote Diagnostic API. You'll learn to monitor, debug, and control your Android device remotely.",
        target: null,
        position: 'center',
        page: 'current'
      },
      ...
      // Main Dashboard
      {
        ...
        content:
          'This is your main dashboard showing real-time system metrics. The cards display CPU cores, RAM usage, battery level, and device uptime.',
        target: '.stat-card',
        position: 'bottom',
        page: 'current'
      },
      {
        ...
        content:
          'These tabs provide access to different system areas: System info, Device details, Processes, Packages, Storage, Terminal, and Logs.',
        target: '.nav-tabs',
        position: 'bottom',
        page: 'current'
      },
      {
        ...
        content:
          "The top navigation provides access to specialized tools. Let's explore each one starting with Files.",
      ...
      // Files Page
      {
        title: 'File Explorer',
        content:
          "Now we're in the File Explorer. Here you can manage your Android device files remotely - upload, download, copy, move, and delete files.",
      ...
      },
      {
        ...
        content:
          'This metrics bar appears on all pages, showing network signal, uptime, battery, RAM usage, and storage. It updates every 30 seconds.',
        target: '#metricsBar',
        position: 'bottom',
        page: '/files.html'
      },
      {
        ...
        content:
          'Use breadcrumb navigation to move between folders. The toolbar provides upload, copy, move, and delete operations for selected files.',
      ...
      // Apps Page
      {
        ...
        content:
          'The Apps page lets you manage installed applications. View app details, uninstall, force stop, or clear cache for selected apps.',
        target: '.main-container',
        position: 'center',
        page: '/apps.html',
        redirect: true
      },
      {
        title: 'App Filtering',
        content:
          'Filter applications by type (System/User), status (Running/All), and sort by name, size, install date, or last update time.',
      ...
      },
      {
        ...
        content:
          'View running apps, total storage usage, and application summary. Select multiple apps for bulk operations.',
      ...
      // Debug Tools Page
      {
        ...
        content:
          'Debug Tools provides advanced system diagnostics: logcat monitoring, system services, process management, and performance profiling.',
        target: '.main-container',
        position: 'center',
      ...
      },
      {
        ...
        content:
          'Explore different debug categories using the accordion. Each section provides specialized tools for system analysis and troubleshooting.',
        target: '.accordion',
        position: 'bottom',
        page: '/debug-tools.html'
      },
      ...
      // Remote Control Page
      {
        ...
        content:
          'The Remote Control page allows you to see and interact with your Android device screen remotely - like having the device in your hands!',
        target: '.main-container',
        position: 'center',
        page: '/remote.html',
        redirect: true
      },
      {
        ...
        content:
          "This canvas shows your device's live screen. Click anywhere to tap, drag to swipe. Screenshots and screen recording are also available.",
      ...
      },
      {
        title: 'Control Panel',
        content:
          'Use hardware buttons (Home, Back, Recent), quick actions (Power, Volume), text input, and app launcher to control your device remotely.',
      ...
      },
      {
        ...
        content:
          'Some features require special Android permissions. The system will guide you through enabling these for full remote control functionality.',
      ...
      // Tutorial Complete
      {
        ...
        content:
          "Congratulations! You've learned about all major features of the Android Diagnostic Dashboard. Use the ? icon on any page for context-specific help.",
        target: null,
        position: 'center',
        page: 'current',
        isLast: true
      ...
      return [
        {
          title: 'Welcome to Android Diagnostic Dashboard!',
          content:
            'Monitor and control your Android device remotely. This dashboard shows real-time system metrics and provides access to all tools.',
          target: null,
          position: 'center'
        },
        {
          ...
          content:
            'These cards show CPU cores, RAM usage, battery level, and uptime. They update automatically every 30 seconds.',
          target: '.stat-card',
          position: 'bottom'
        },
        {
          title: 'Navigation Tabs',
          content:
            'Access different system areas: System info, Device details, Processes, Packages, Storage, Terminal, and Logs.',
          target: '.nav-tabs',
          position: 'bottom'
        },
        {
          ...
          content:
            'Top navigation provides access to Files, Apps, Debug Tools, and Remote Control features.',
          target: '.d-flex.align-items-center a',
          position: 'bottom'
        }
      ];
      ...
      return [
        {
          title: 'File Explorer',
          content:
            'Manage Android device files remotely. Upload, download, copy, move, and delete files with ease.',
          target: '.main-container',
          position: 'center'
        },
        {
          title: 'System Metrics',
          content:
            'Monitor device status: network signal, uptime, battery, RAM usage, and storage space.',
          target: '#metricsBar',
          position: 'bottom'
        }
      ];
      ...
      return [
        {
          title: 'Application Manager',
          content:
            'Manage installed applications. View details, uninstall, force stop, or clear cache for selected apps.',
          target: '.main-container',
          position: 'center'
        },
        {
          title: 'App Filtering',
          content:
            'Filter by type, status, and sort by various criteria. Use checkboxes for bulk operations.',
          target: '.filters-panel',
          position: 'bottom'
        }
      ];
      ...
      return [
        {
          title: 'Debug Tools',
          content:
            'Advanced diagnostics: logcat monitoring, system services, process management, and performance profiling.',
          target: '.main-container',
          position: 'center'
        },
        {
          title: 'Debug Categories',
          content:
            'Explore different debug sections using the accordion interface for specialized system analysis.',
          target: '.accordion',
          position: 'bottom'
        }
      ];
      ...
      return [
        {
          title: 'Remote Control',
          content:
            'Control your Android device remotely! See the live screen and interact using mouse or touch.',
          target: '.main-container',
          position: 'center'
        },
        {
          title: 'Device Screen',
          content:
            'Live screen mirror. Click to tap, drag to swipe. Take screenshots or record the screen.',
          target: '.screen-panel',
          position: 'right'
        },
        {
          title: 'Control Panel',
          content:
            'Hardware buttons, quick actions, text input, and app launcher for complete remote control.',
          target: '.control-panel',
          position: 'left'
        }
      ];
    ...
    return [
      {
        title: 'Welcome!',
        content:
          'Welcome to the Android Diagnostic Dashboard. Use the navigation to explore different features.',
        target: null,
        position: 'center'
      }
    ];
